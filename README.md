...
+ Mina Jiang: Worked on the Covid map part of the project with Yunuo, debugging when necessary. Developed the reference page with Minzhi and made reformatting for better displaying. Deployed the app for the group and fixed minor issues during the publishing such as readjusting picture size to make page more presentable. Prepared, organized and carried out the in-class presentation of the project. 
