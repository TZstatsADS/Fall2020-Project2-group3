                        ...
                        tabItem(tabName='Home',
                            ...
                            br(),
                                fluidRow(
                                  ...
                                  br(),
                                  img(src="https://raw.githubusercontent.com/TZstatsADS/Fall2020-Project2-group3/master/app/www/business_histgram_home.png?token=AG54Q4NE7C2QB3Y556TTELS7SBWOA",width=355,height=320,style="float: left;margin:auto 0;"),
