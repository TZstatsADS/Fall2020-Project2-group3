                                  ...
                                  mainPanel(width=12,
                                            ...
                                            column(12,
                                                   h4("This app uses data from", 
                                                      ...
                                                      "and data from", 
                                                      tags$a(href = "https://github.com/CSSEGISandData/COVID-19/tree/master/csse_covid_19_data" , "the 2019 Novel Coronavirus Visual Dashboard"),
                                            ...
                                            column(12,
                                                   tags$ul(
                                                     tags$li(h4('The Covid-19 data contains number of confirmed, active, death, recovered cases across each state in the U.S. in a daily time series summary.')),
                                                     tags$li(h4('Testing Rate: the rate of people getting testing for Covid 19.')),
                                                     tags$li(h4('Incident Rate: the proportion of new cases to people at risk.')),
                                                     tags$li(h4('Hospitalization Rate: the rate of people getting hospitalized'))
                                                   )
                                                   ),
                                            
                                            h1(strong("About the Team"), align = "center"),
                                            h4("This app is designed and created by", 
                                               em("Mina Jiang, Yunuo Ma, Xinyi Wei, Minzhi Zhang"))
